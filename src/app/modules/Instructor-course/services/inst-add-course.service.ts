...
export class InstAddCourseService {
  ...
  studentsGrades(courseId:any):Observable<any>{
  ...
  searchGrade(id:any,username: any): Observable<any>{
    return this._http.get(`http://localhost:3000/searchGradeInstructor/${id}/?username=${username}`)
  }
}